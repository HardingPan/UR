"""
train-piv.py
训练针对piv图像(256*256)的raft模型(带图像增强)
训练指令: python train-piv-transform.py --name piv --stage piv --gpus 0 --num_steps 700 --batch_size 1 --lr 0.0005 --image_size 256 256 --mixed_precision
"""
